...
export default function Project({ image, name, url, description }) {
  return (
    <motion.li
      ...
      className="border-4 border-opacity-20 border-black rounded-lg bg-zinc-800 w-[80%] md:w-[60%] xl:w-[65%] 2xl:w-[50%] lp:w-[50%] text-white text-xl sm:text-2xl md:text-2xl lp:text-xl flex flex-col items-center justify-center gap-10 m-auto pb-11 shadow-lg mt-14 -mb-11"
    >
      <img
        src={image}
        alt={name}
